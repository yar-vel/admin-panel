...
export interface IResList<T extends object, S extends object = T, F extends object = T> {
    rows: T[];
    meta?: IResListMeta<T, S, F>;
}
export interface IResListMeta<T extends object, S extends object = T, F extends object = T> {
    page?: number;
    limit?: number;
    total?: number;
    sort?: ISort<S>;
...
export interface IFetchUpdate<T = unknown, U = T extends {
    id: infer P;
} ? P : string | number> {
    id: U;
    fields: T;
